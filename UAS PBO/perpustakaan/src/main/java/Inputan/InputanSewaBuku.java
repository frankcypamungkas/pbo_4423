...
import java.util.logging.Logger; /*memanggil package logging loggerr */
import Interfaces.InterfacesSewaBuku; /* memanggil InterfaceSewaBuku*/

/**
 *
 * @author frankcy
 */
public class InputanSewaBuku {
